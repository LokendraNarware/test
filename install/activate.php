...
if (isset($_GET['code'])) {
    $studio->setopt("api.secretkey", $_GET['code']);
...
<body>
    <div class="panel">
        <table cellspacing="0" cellpadding="0">
            <tr valign="top">
                ...
                <td>
                    <h1>Activate Studio</h1>
                    <?php if ($error != "") echo "<div style=\"margin-top: 10px;\" class=\"error\">$error</div>"; ?>

                    <p>Licensing your product is easy. Just click the button below to sign into your Envato account and we'll instantly verify your purchase. Doing so will unlock the following benefits:</p>

                    <ul>
                        <li>Access to free plugins and themes from the Market.</li>
                        <li>Access to the built-in support ticket system.</li>
                        <li>Get around Google blocks for free - forever!</li>
                        <li>Free automatic updates.</li>
                    </ul>

                    <div style="margin: 20px 0 0;">
                        <a class="btn blue" href="javascript:;" onclick="goLogin()">Activate</a>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <script>
        function goLogin() {
            ...
            window.location = "https://api.getseostudio.com/v1/authorization?method=connect&redirect_uri=" + encodeURIComponent(loc);
        }
    </script>
</body>
</html>
