                ...
                <td width="225px">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li class="done"><a>Updates</a></li>
                            <li class="active"><a>Configure cron</a></li>
                        </ul>
                    </nav>
                </td>
                <td>
                    ...
                    <p>Please set up the following cron job on your server. If you are unsure how to do this, you can ask your web host to set it up for you.</p>

                    <pre>0 */12 * * * php -q <?php
                    echo dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . "includes" . DIRECTORY_SEPARATOR . "execute" . DIRECTORY_SEPARATOR . "cron.php";
                    ?></pre>

                    <?php if ($api->isAuthorized()) { ?>
                    <div style="margin: 35px 0;">
                        <p>Because this copy is licensed, you may also use our free cron service, which will configure your cron automatically. If you wish to enable this service, you will be able to do so from the admin panel (Cron Job page) once setup completes.</p>
                    </div>
                    <?php } ?>

                    <a class="btn blue" href="finish.php">Finish</a>
                </td>
            </tr>
        </table>
    </div>
